...
# here (https://github.com/pytorch/vision/tree/master/torchvision/models) to find the download link of pretrained params

root = '/home/yuliang/code/MobilePose-pytorch/params/pretrained'
